          ...
          <div class="card h-100 shadow bg-light">
            <div class="card-body">
              ...
              <div class="row">
                ...
                <div class="col-lg-8 mb-4">
                  <div>
                    <p class="lead">We are working with laboratories internationally that use our S3000 software to process spectral data generated from plant, soil, feed and manure samples.</p>
              ...
              <div class="row">
                <div class="col-lg-8 mb-4">
                  <div>
                    ...
                    <p class="lead">You can email <strong><a href="https://profiles.waikato.ac.nz/peter.reutemann">Peter Reutemann</a></strong> at <em>fracpete@waikato.ac.nz</em></p>
                    <p class="lead">Or <strong><a href="https://profiles.waikato.ac.nz/dale.fletcher">Dale Fletcher</a></strong> at <em>dale.fletcher@waikato.ac.nz</em></p>
                  </div>
                </div>
                <div class="col-lg-4 mb-4">
                  <div>
